...
public class ChessBoardTest
{
    ...
    {
        ArgumentNullException e = Assert.Throws<ArgumentNullException>(() => ChessBoard.ValidatePosition(null!));
    ...
    {
        ArgumentException e = Assert.Throws<ArgumentException>(() => ChessBoard.ValidatePosition(""));
    ...
    {
        ArgumentException e = Assert.Throws<ArgumentException>(() => ChessBoard.ValidatePosition("A"));
    ...
    {
        ArgumentException e = Assert.Throws<ArgumentException>(() => ChessBoard.ValidatePosition("AA2"));
    ...
    {
        ArgumentException e = Assert.Throws<ArgumentException>(() => ChessBoard.ValidatePosition(".2"));
    ...
    {
        ArgumentException e = Assert.Throws<ArgumentException>(() => ChessBoard.ValidatePosition("Q2"));
    ...
    {
        ArgumentException e = Assert.Throws<ArgumentException>(() => ChessBoard.ValidatePosition("A0"));
    ...
    {
        ArgumentException e = Assert.Throws<ArgumentException>(() => ChessBoard.ValidatePosition("A9"));
